...
@push('metaData')
    <meta name="keywords" content="hakkımda, muhammet ali fidan, coderlog" />
    <meta name="description" content="Muhammet Ali Fidan kimdir? Hakkımdaki bilgileri öğrenin ve benimle iletişime geçin.">
    <title>{{ __('Hakkımda') }}</title>
@endpush
...
@section('content')
        ...
        <div class="row mb-2">
            <div class="col-md-7 order-2">
                ...
                <div class="row align-items-center appear-animation" data-appear-animation="fadeInUpShorter"
                    data-appear-animation-delay="600">
                    <div class="col-lg-8">
                        <a href="{{ route('frontend.about.downloadcv') }}"
                            class="btn btn-modern btn-dark mt-3">{{ _('Özgeçmişimi(CV) İndir') }}</a>
                        <a href="{{ route('frontend.contact.index') }}"
                            class="btn btn-modern btn-primary mt-3 ms-3">{{ _('Benimle İletişim Kur') }}</a>
                    </div>
                    ...
                    <div class="col-sm-4 text-lg-end my-4 my-lg-0">
                        ...
                        <ul class="social-icons float-lg-end">
                            ...
                            <li class="social-icons-linkedin"><a href="https://www.linkedin.com/in/muhammetalifidan/"
    ...
    <section class="section section-default border-0 mt-5 appear-animation" data-appear-animation="fadeIn"
        data-appear-animation-delay="600">
        <h2 class="text-color-dark font-weight-normal text-7 mb-3 pt-1 text-center"><strong
                class="font-weight-extra-bold">{{ _('Kendimi Geliştirdiğim Alanlar') }}</strong></h2>
    ...
    <div class="container pt-3 pb-2">
        <div class="row">
            <div class="col-md-8 mx-md-auto text-center">
                ...
                <h2 class="text-color-dark font-weight-normal text-7 mb-0 pt-2"><strong
                        class="font-weight-extra-bold">{{ _('Deneyimim') }}</strong></h2>
                ...
                <section class="timeline" id="timeline">
                    <div class="timeline-body">
                        ...
                        <article class="timeline-box left text-start appear-animation" data-appear-animation="fadeIn"
                            data-appear-animation-delay="600">
