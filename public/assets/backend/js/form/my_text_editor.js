const AddModalEditor = function() {

    // Basic CkEditor examples
    const _componentCkEditor = function() {
...
const UpdateModalEditor = function() {

    // Basic CkEditor examples
    const _componentCkEditor = function() {

        ckEditor = CKEDITOR.ClassicEditor.create(document.getElementById("my_update_modal_editor"), {
            toolbar: {
                items: [
                    'heading', '|', 'fontSize', 'fontFamily', 'fontColor', 'fontBackgroundColor',
                    'bold', 'italic', 'strikethrough', 'underline', '|', 'findAndReplace', '-',
