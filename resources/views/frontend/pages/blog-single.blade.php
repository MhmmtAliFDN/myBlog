                ...
                <article class="post post-large blog-single-post border-0 m-0 p-0">
                    ...
                    <div class="post-image ms-0">
                        <a href="blog-post.html">
                            <img src="{{asset($blog->image)}}" class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0" alt="blog-image" />
                        </a>
                    </div>
                    ...
                    <div class="post-content ms-0">
                        ...
                        <div class="post-meta">
                            <span><i class="far fa-user"></i> {{_('Yazar')}} <a href="#">{{$blog->user->name}}</a> </span>
                            <span><i class="far fa-folder"></i> {{_('Kategori')}} <a href="{{route('frontend.blog.getbycategory', ['categorySlug' => $blog->category->slug])}}">{{$blog->category->name}}</a> </span>
                        ...
                        <div class="post-block mt-4 pt-2 post-author">
                            ...
                            <p><strong class="name"><a href="#" class="text-4 pb-2 pt-2 d-block">{{$blog->user->name}}</a></strong></p>
