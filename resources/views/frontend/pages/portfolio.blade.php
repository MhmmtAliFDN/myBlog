...
@push('title')
    <title>{{ __('Muhammet Ali Fidan | Çalışmalar') }}</title>
@endpush
                    ...
                    <div class="col-md-12 align-self-center p-static order-2 text-center">
                        <div class="overflow-hidden pb-2">
                            <h1 class="text-dark font-weight-bold text-9 appear-animation"
                                data-appear-animation="maskUp" data-appear-animation-delay="100">{{_('Geliştirdiğim Projelerim')}}</h2>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="overflow-hidden">
                                    <h2 class="text-color-dark font-weight-bold text-5 mb-2 appear-animation"
                                        data-appear-animation="maskUp" data-appear-animation-delay="200"><a href="{{route('frontend.portfolio.getsingleportfolio', ['categorySlug' => $portfolio->category->slug, 'portfolioSlug' => $portfolio->slug])}}"> {{$portfolio->name}} </a></h2>
                                </div>
